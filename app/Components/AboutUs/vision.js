        ...
        <>
            <div class="w-screen bg-white border border-gray-200 rounded-lg shadow mt-8 lg:hidden">
                ...
                <div class="p-5 bg-visionColor rounded-b-lg">
                    ...
                    <p class="mb-3 font-normal text-gray-100 ">We aim to to be the super app providing custom payment solution to the masses.</p>
                </div>
            </div>
            <div className="hidden lg:flex">
                <div class="w-screen bg-visionColor mt-8 justify-center flex fkex-row items-center">
                    <img class="rounded-lg" style={{maxWidth:"30%",height:"auto"}} src="./assets/Vision-removebg-preview.png" alt="" />
                    <div class="p-5 ">
