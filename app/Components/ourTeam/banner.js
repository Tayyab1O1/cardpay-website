...
function Banner() {
    ...
    return (
        <div className="hero w-screen bg-lightGreen bg-opacity-60 flex flex-col lg:flex-row  items-center pt-2 pb-6">
            ...
            <div>
                <h1 className="text-black font-semibold text-xl lg:text-4xl">The Aces of CardPay</h1>
            ...
            <h2 className="text-gray-700 font-medium px-4 lg:hidden">Where dedication, collaboration, and brilliance converge</h2>
        </div>
    )
